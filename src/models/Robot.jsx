...
import robotScene from '../assets/3d/robot_playground.glb'

const Robot = ({isRotating, setIsRotating, currentAnimation, ...props}) => {
  const group = useRef()
  ...
  const handlePointerMove = (e) => {
    ...
    if(isRotating){
      ...
      group.current.rotation.y += delta * 0.00004 * Math.PI;

      lastX.current = clientX

      rotationSpeed.current = delta * 0.00004 * Math.PI;
    }
  }
