...
import exploreScene from '../assets/3d/explore.glb'

const Explore = ({islandAnimation, ...props}) => {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF(exploreScene)
  const { actions } = useAnimations(animations, group)

  useEffect(() => {
    if(actions[islandAnimation]){
        actions[islandAnimation].play()
    }
  }, [actions, islandAnimation])
