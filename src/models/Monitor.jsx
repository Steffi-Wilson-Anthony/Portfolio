...
import Screen from '../assets/3d/monitor.glb'

const Monitor = ({monitorAnimation, ...props}) => {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF(Screen);
  const { actions } = useAnimations(animations, group)

  useEffect(() => {
    if(actions[monitorAnimation]){
      actions[monitorAnimation].play();
    }
  }, [actions, monitorAnimation]);
